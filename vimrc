...
let g:ditto_dir = '$HOME/.cache/ditto'
...
let g:ale_c_clang_check_options = '--extra-arg="-D_LARGEFILE64_SOURCE" --extra-arg="-D_GNU_SOURCE" --extra-arg="-std=c99"'

" EasyTags config
let g:easytags_async = 1
let g:easytags_file = '$HOME/.cache/vimtags'
