...
update "$HOME/.config/newsboat" "cache.db urls schemes"
update "$HOME/.config/sakura"
update "$HOME/.config/bspwm"
update "$HOME/.config/polybar"
update "$HOME/.config/sxhkd"
update "$HOME/.config/dunst"
update "$HOME/.config/sway"
update "$HOME/.config/waybar"
update "$HOME/.config/hypr"
update "$HOME/.config/autostart"
