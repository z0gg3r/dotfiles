...
local browser3          = "shopfox"
local editor            = os.getenv("EDITOR") or "vim"
local editorgui         = "notepadqq"
local filemanager       = "thunar"
local mailclient        = "neomutt"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "w", function () awful.util.spawn( "librewolf" ) end,
        {description = "Launch LibreWolf", group = "function keys"}),
    -- dmenu
    awful.key({ modkey, "Shift" }, "d",    
    function () awful.util.spawn("xfce4-appfinder") end,
    {description = "show xfce4-appfinder", group = "hotkeys"}),
    ...
    awful.key({ modkey }, "c", function () awful.util.spawn( "/home/zocki/.config/scripts/unicode.sh" ) end,
        {description = "Launch Unicode Copy Selector", group = "selectors"}),
    awful.key({ modkey }, "a", function () awful.util.spawn("/home/zocki/.config/scripts/abook.sh") end,
    	{description = "Launch Addressbook Selector", group = "selectors"}),
    awful.key({ modkey, "Shift" }, "e", function () awful.util.spawn("/home/zocki/.config/scripts/emoji.sh") end,
    ...
    awful.key({ modkey, "Shift" }, "s", function() awful.util.spawn("/bin/sh /home/zocki/.config/scripts/screenkey.sh") end,
    { description = "Toggle screenkey", group = "super"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- Print bookmarked url
    awful.key({ modkey }, "b", function () awful.util.spawn("/home/zocki/.config/scripts/bookmarks.sh") end,
        {description = "Launch Bookmark Selector", group = "selectors" }),
